                    ...
                    <div class="right-wrapper">
                        <ol class="breadcrumbs">
                            ...
                            <?php
                                ...
                                ?>
                            <li><a href="add_company" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4 ">+ Add Company</a></li>
                            <?php
                                }
                            ?>
                                ...
                                <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="5%">GST Aplicable</th>
                                            <th width="15%">GST Number</th>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($sql_result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['gst_aplicable']; ?></td>
