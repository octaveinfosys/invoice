                    ...
                    <div class="right-wrapper">
                        <ol class="breadcrumbs">
                            ...
                            <?php
                                ...
                                ?>
                            <li><a href="add_logo" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4 ">+ Add Logo</a></li>
                            <?php
                                }
                            ?>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($sql_result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><image src=" <?php echo $row['logo']; ?>" style="width: 100px" /></td>
